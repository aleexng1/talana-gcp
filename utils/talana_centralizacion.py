...
def main(data, context=None):
    ...
    endpoints = [
        #CentralizaciónContable
        (f"https://talana.com/es/api/centralizacion-contable-generica?ano={last_year}&mes={last_month}", "centralizacion_contable_output.ndjson", "CentralizacionContable.ndjson")
    ]
...
def procesar():
    ...
    logging.info("=== Ejecutando talana_centralizacion.procesar() ===")
    main(data=None)
