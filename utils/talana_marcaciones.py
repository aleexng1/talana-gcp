...
def main(data, context=None):
    ...
    endpoints = [
        #Marcaciones
        (f"https://talana.com/es/api/mark/?desde={yesterday}&hasta={yesterday}", "mark_output.ndjson", "Marcaciones.ndjson")
    ]
...
def procesar():
    ...
    logging.info("=== Ejecutando talana_marcaciones.procesar() ===")
    main(data=None)
