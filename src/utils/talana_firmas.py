...
def main(data=None, context=None):
    """
    Función principal que define y ejecuta los endpoints de firmas electrónicas.
    """
    ...
    logger.info("Todos los endpoints de firmas han sido procesados.")
...
def procesar():
    ...
    """
    logger.info("=== Ejecutando talana_firmas.procesar() ===")
    main()
