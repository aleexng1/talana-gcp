...
def main(data=None, context=None):
    """
    Función principal para obtener las marcaciones del día anterior.
    """
    yesterday = get_yesterday_date()

    url = f"https://talana.com/es/api/mark/?desde={yesterday}&hasta={yesterday}"
    output_filename = "mark_output.ndjson"
    remote_filename = "Marcaciones.ndjson"
    ...
    logger.info("Marcaciones procesadas correctamente.")
...
def procesar():
    ...
    """
    logger.info("=== Ejecutando talana_marcaciones.procesar() ===")
    main()
